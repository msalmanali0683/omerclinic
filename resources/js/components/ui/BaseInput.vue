<template>
  ...
  <div class="w-full">
    ...
    <div v-if="isPasswordField && showPasswordToggle" class="relative">
      ...
      >
        ...
        <svg v-if="passwordVisible" class="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">
...
function inputClasses(extra = '') {
  ...
  return [
    ...
    props.error ? 'border-red-500 focus:ring-red-500 focus:border-red-500' : 'border-gray-300 dark:border-gray-600',
